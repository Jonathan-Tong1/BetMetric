...
// app.get("/odds/:sportKey", async (req, res) => {
...
// app.get("/odds/best/:sportKey", async (req, res) => {
//   const { sportKey } = req.params;
...
// app.get("/odds/ev/:sportKey", async (req, res) => {
//   const { sportKey } = req.params;
...
//           const estimatedProb = 1 / numOutcomes; // simple fair probability
